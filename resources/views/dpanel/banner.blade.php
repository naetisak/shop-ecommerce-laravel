                                ...
                                <tr>
                                    ...
                                    <td class="pl-3 py-3">
                                        <select onchange="updateStatus(this, '{{ $item->id }}')"
                                            class="bg-gray-100 border rounded focus:outline-none">
            ...
            <form action="{{ route('dpanel.banner.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <div class="text-center">
                        <button
                            class="bg-indigo-500 text-center text-white py-1 px-2 rounded shadow-md uppercase">Create</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="flex justify-center items-center min-h-[30vh] md:min-h-[50vh]">
            <form id="edit-form" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div>
                        <label>Name <span class="text-red-500 font-bold">*</span></label>
                        <input type="text" name="name" id="banner-name" maxlength="255" required
                    ...
                    <div>
                        ...
                        <select name="is_active" id="status"
                            class="w-full bg-gray-100 border border-gray-500 rounded px-2 py-0.5 focus:outline-none">
